...
Package directory `rfc6749` implements
the [RFC 6749 — The OAuth 2.0 Authorization Framework](https://datatracker.ietf.org/doc/html/rfc6749).

It provides grant flows, client authentication, and authorization code generation as composable sub-packages. All flows
are wired through the `authkit.Server` dispatcher at the root package.
