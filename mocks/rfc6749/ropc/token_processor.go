...
func (_m *MockTokenProcessor) ProcessToken(ctx context.Context, r *requests.TokenRequest, token models.TokenReader, data map[string]interface{}) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *requests.TokenRequest, models.TokenReader, map[string]interface{}) error); ok {
...
func (_c *MockTokenProcessor_ProcessToken_Call) Run(run func(ctx context.Context, r *requests.TokenRequest, token models.TokenReader, data map[string]interface{})) *MockTokenProcessor_ProcessToken_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*requests.TokenRequest), args[2].(models.TokenReader), args[3].(map[string]interface{}))
	})
	return _c
}
...
func (_c *MockTokenProcessor_ProcessToken_Call) RunAndReturn(run func(context.Context, *requests.TokenRequest, models.TokenReader, map[string]interface{}) error) *MockTokenProcessor_ProcessToken_Call {
	_c.Call.Return(run)
	return _c
}
